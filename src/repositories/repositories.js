import { repositoryStars } from './repository-stars.js'
...
export const repositories = [
  {
    ...
    stars: repositoryStars.blitzstrike,
    category: 'security',
    icon: 'bolt',
  ...
  },
  {
    ...
    stars: repositoryStars.impeccable,
    category: 'design',
  ...
  },
  {
    ...
    stars: repositoryStars['viserys-agent'],
    category: 'agent-tools',
    icon: 'smart_toy',
